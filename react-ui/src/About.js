...
function Users() {
  return ( <React.Fragment><h1 class="text-center">About</h1>
      ...
      <p class="fs-5 mb-5">Yep, just log in with Discord (hit the link in the top right), and you'll be able to vote if the next game is known.</p>
      ...
      <p class="fs-5 mb-5">I am very much a back-end developer, not a front-end developer. I tried my best, but if you fancy polishing this turd, feel free to reach out to me (area#2758) in the Old Gamer's Almanac section of the <a href="https://spacecatspeaceturtles.com/community/community/">SCPT Discord</a>.</p>
  </React.Fragment>
  )
}
